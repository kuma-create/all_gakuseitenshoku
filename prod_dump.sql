...
CREATE OR REPLACE FUNCTION "public"."propagate_role_to_profile"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."propagate_role_to_profile"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."sync_student_role"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
begin
...
ALTER FUNCTION "public"."sync_student_role"() OWNER TO "postgres";
...
CREATE OR REPLACE VIEW "public"."company_member_emails" AS
 SELECT "u"."id",
    "u"."email",
    "cm"."company_id"
   FROM ("auth"."users" "u"
...
ALTER TABLE "public"."company_member_emails" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."company_student_memos" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "company_id" "uuid" NOT NULL,
    "student_id" "uuid" NOT NULL,
    "memo" "text" NOT NULL,
...
ALTER TABLE "public"."company_student_memos" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."internship_short_details" (
    "job_id" "uuid" NOT NULL,
    "period_days" integer,
    "working_days" "text",
    "stipend" integer,
...
ALTER TABLE "public"."internship_short_details" OWNER TO "postgres";
...
CREATE OR REPLACE VIEW "public"."student_with_email" AS
...
ALTER TABLE "public"."student_with_email" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."company_student_memos"
    ADD CONSTRAINT "company_student_memos_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."internship_short_details"
    ADD CONSTRAINT "internship_short_details_pkey" PRIMARY KEY ("job_id");
...
CREATE OR REPLACE TRIGGER "trg_set_updated_at" BEFORE UPDATE ON "public"."company_student_memos" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
CREATE OR REPLACE TRIGGER "trg_sync_role" AFTER INSERT OR UPDATE ON "public"."user_roles" FOR EACH ROW EXECUTE FUNCTION "public"."sync_student_role"();
...
ALTER TABLE ONLY "public"."company_student_memos"
    ADD CONSTRAINT "company_student_memos_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."company_student_memos"
    ADD CONSTRAINT "company_student_memos_student_id_fkey" FOREIGN KEY ("student_id") REFERENCES "public"."student_profiles"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."internship_short_details"
    ADD CONSTRAINT "internship_short_details_job_id_fkey" FOREIGN KEY ("job_id") REFERENCES "public"."jobs"("id") ON DELETE CASCADE;
...
CREATE POLICY "Admin or Owner can read resumes" ON "public"."resumes" FOR SELECT USING ((("auth"."uid"() = "user_id") OR (("auth"."jwt"() ->> 'role'::"text") = 'admin'::"text")));



CREATE POLICY "Admin or Owner can update resumes" ON "public"."resumes" FOR UPDATE USING ((("auth"."uid"() = "user_id") OR (("auth"."jwt"() ->> 'role'::"text") = 'admin'::"text")));
...
CREATE POLICY "Admins can read all roles" ON "public"."user_roles" FOR SELECT USING (((("auth"."jwt"() ->> 'is_admin'::"text"))::boolean = true));
...
CREATE POLICY "Allow anonymous insert" ON "public"."inquiries" FOR INSERT WITH CHECK (true);
...
CREATE POLICY "Owners can read own company_members" ON "public"."company_members" FOR SELECT USING (("user_id" = "auth"."uid"()));
...
CREATE POLICY "Users can read own company_members" ON "public"."company_members" FOR SELECT USING (("user_id" = "auth"."uid"()));
...
GRANT ALL ON FUNCTION "public"."propagate_role_to_profile"() TO "anon";
GRANT ALL ON FUNCTION "public"."propagate_role_to_profile"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."propagate_role_to_profile"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."sync_student_role"() TO "anon";
GRANT ALL ON FUNCTION "public"."sync_student_role"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."sync_student_role"() TO "service_role";
...
GRANT ALL ON TABLE "public"."company_member_emails" TO "anon";
GRANT ALL ON TABLE "public"."company_member_emails" TO "authenticated";
GRANT ALL ON TABLE "public"."company_member_emails" TO "service_role";



GRANT ALL ON TABLE "public"."company_student_memos" TO "anon";
GRANT ALL ON TABLE "public"."company_student_memos" TO "authenticated";
GRANT ALL ON TABLE "public"."company_student_memos" TO "service_role";
...
GRANT ALL ON TABLE "public"."internship_short_details" TO "anon";
GRANT ALL ON TABLE "public"."internship_short_details" TO "authenticated";
GRANT ALL ON TABLE "public"."internship_short_details" TO "service_role";
...
GRANT ALL ON TABLE "public"."student_with_email" TO "anon";
GRANT ALL ON TABLE "public"."student_with_email" TO "authenticated";
GRANT ALL ON TABLE "public"."student_with_email" TO "service_role";
