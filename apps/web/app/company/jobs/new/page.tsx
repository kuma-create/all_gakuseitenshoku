    ...
    if (selectionType === "intern_long") {
      ...
      if (formData.remunerationType === "hourly") {
        if (!formData.hourlyWageMin.trim()) {
          newErrors.hourlyWageMin = "最低時給を入力してください";
        } else if (parseNumber(formData.hourlyWageMin) === null) {
          newErrors.hourlyWageMin = "数字で入力してください（例: 1500）";
        }
          ...
          .upsert(
            {
              ...
              hourly_wage_min     : formData.remunerationType === "hourly"
                                      ...
                                      : null,
              hourly_wage_max     : formData.remunerationType === "hourly" && formData.hourlyWageMax
                                      ? parseNumber(formData.hourlyWageMax)
                                      : null,
      ...
      <div className="flex flex-col space-y-6">
        ...
        {showSuccessOptions ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="内容の詳細を記入してください。具体的な業務内容、プロジェクト、チーム構成などを含めると良いでしょう。"
                  />
            ...
            {/* Notes (備考) – only for long‑term internship */}
            {isInternLong && (
              <Card>
                <CardHeader>
                  <div className="flex items-center gap-2">
