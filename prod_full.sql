...
CREATE OR REPLACE TRIGGER "trg_create_student_profile" AFTER INSERT ON "auth"."users" FOR EACH ROW EXECUTE FUNCTION "public"."f_create_student_profile"();



CREATE OR REPLACE TRIGGER "trg_sync_user_roles" AFTER INSERT ON "auth"."users" FOR EACH ROW EXECUTE FUNCTION "public"."sync_user_roles"();
...
CREATE POLICY "Authenticated can read media" ON "storage"."objects" FOR SELECT USING ((("bucket_id" = 'media'::"text") AND ("auth"."role"() = 'authenticated'::"text")));



CREATE POLICY "Authenticated can upload to media" ON "storage"."objects" FOR INSERT WITH CHECK ((("bucket_id" = 'media'::"text") AND ("auth"."role"() = 'authenticated'::"text")));



CREATE POLICY "Authenticated uploads" ON "storage"."objects" FOR INSERT WITH CHECK ((("bucket_id" = 'media'::"text") AND ("auth"."role"() = 'authenticated'::"text")));



CREATE POLICY "allow_company_logo_delete" ON "storage"."objects" FOR DELETE TO "authenticated" USING (("bucket_id" = 'company-logos'::"text"));



CREATE POLICY "allow_company_logo_insert" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK (("bucket_id" = 'company-logos'::"text"));



CREATE POLICY "allow_company_logo_select" ON "storage"."objects" FOR SELECT TO "authenticated" USING (("bucket_id" = 'company-logos'::"text"));



CREATE POLICY "allow_company_logo_update" ON "storage"."objects" FOR UPDATE TO "authenticated" USING (("bucket_id" = 'company-logos'::"text")) WITH CHECK (("bucket_id" = 'company-logos'::"text"));



CREATE POLICY "attachments anon select" ON "storage"."objects" FOR SELECT USING (("bucket_id" = 'attachments'::"text"));



CREATE POLICY "attachments auth write" ON "storage"."objects" USING ((("bucket_id" = 'attachments'::"text") AND ("auth"."role"() = 'authenticated'::"text")));



CREATE POLICY "auth users can read job-covers" ON "storage"."objects" FOR SELECT TO "authenticated" USING (("bucket_id" = 'job-covers'::"text"));



CREATE POLICY "auth users can upload job-covers" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK (("bucket_id" = 'job-covers'::"text"));



CREATE POLICY "avatars insert" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK (("bucket_id" = 'avatars'::"text"));
...
CREATE POLICY "avatars update" ON "storage"."objects" FOR UPDATE TO "authenticated" USING (("bucket_id" = 'avatars'::"text"));
...
CREATE POLICY "company-covers delete" ON "storage"."objects" FOR DELETE TO "authenticated" USING (("bucket_id" = 'company-covers'::"text"));



CREATE POLICY "company-covers insert" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK (("bucket_id" = 'company-covers'::"text"));



CREATE POLICY "company-covers select" ON "storage"."objects" FOR SELECT TO "authenticated" USING (("bucket_id" = 'company-covers'::"text"));



CREATE POLICY "company-covers update" ON "storage"."objects" FOR UPDATE TO "authenticated" USING (("bucket_id" = 'company-covers'::"text")) WITH CHECK (("bucket_id" = 'company-covers'::"text"));
...
CREATE POLICY "upload job-covers" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK ((("bucket_id" = 'job-covers'::"text") AND ("auth"."uid"() IS NOT NULL)));
