    ...
    const mockCompanies: Company[] = [
      {
        ...
        stages: [
          ...
          },
          {
            ...
            feedback: '履歴書とポートフォリオが高く評価されました。',
            rating: 4
          },
          {
            id: '1-3',
            ...
            time: '14:00',
            location: 'オンライン',
            preparation: ['アルゴリズム復習', 'LeetCode問題練習']
          },
          {
            id: '1-4',
            name: '技術面接',
        ...
        contacts: [
          { name: '田中 HR', role: '人事担当', email: 'hr@google.com' },
          { name: '佐藤エンジニア', role: 'テックリード', email: 'sato@google.com' }
        ],
        jobDetails: {
          title: 'ソフトウェアエンジニア',
          salary: '800-1200万円',
          benefits: ['住宅手当', '交通費全額支給', '健康保険', 'ストックオプション'],
          requirements: ['CS学位', 'プログラミング経験3年以上', '英語力'],
          description: '次世代のWebサービスを開発するソフトウェアエンジニアを募集'
        }
      },
      {
        id: '2',
        ...
        stages: [
          ...
          },
          {
            ...
            feedback: 'リーダーシップ経験と論理的思考力が評価されました。',
            rating: 4
          },
          {
            id: '2-3',
          ...
          },
          {
            ...
            time: '15:00',
            location: '東京オフィス',
            interviewer: '鈴木シニアパートナー',
            preparation: ['志望動機の深堀り', 'リーダーシップ体験準備']
          }
        ],
        contacts: [
          { name: '山田パートナー', role: 'パートナー', email: 'yamada@mckinsey.com' },
          { name: '人事部', role: '採用担当', email: 'recruit@mckinsey.com' }
        ],
        jobDetails: {
          title: 'ビジネスアナリスト',
          salary: '700-1000万円',
          benefits: ['海外研修', '資格取得支援', '住宅手当'],
          requirements: ['論理的思考力', 'リーダーシップ経験', '英語力'],
          description: '企業の戦略立案と実行支援を行うコンサルタント'
        }
      },
      {
        id: '3',
        ...
        currentStage: 4,
        priority: 'medium',
        notes: 'デジタル領域でのコンサルティング経験を積める環境。',
        ...
        stages: [
          ...
          },
          {
            ...
            feedback: '内定通知を受領。年収650万円、4月入社予定。',
            rating: 5
          }
        ],
        contacts: [
          { name: '佐々木マネージャー', role: 'マネージャー', email: 'sasaki@accenture.com' }
        ],
        jobDetails: {
          title: 'テクノロジーコンサルタント',
          salary: '650万円',
          benefits: ['住宅手当', '交通費支給', '研修制度充実'],
          requirements: ['技術的バックグラウンド', 'コミュニケーション能力'],
          description: 'デジタル変革を支援するテクノロジーコンサルタント'
        }
      },
      {
        id: '4',
        ...
        stages: [
          {
            ...
            feedback: '経験年数が不足していると判断されました。',
            rating: 2
          }
        ],
        contacts: [
          { name: 'CTO田村', role: 'CTO', email: 'tamura@xyz.com' }
        ],
        jobDetails: {
          title: 'フロントエンドエンジニア',
          salary: '400-600万円',
          benefits: ['フレックス勤務', 'リモート可'],
          requirements: ['React経験', 'TypeScript']
        }
      },
      {
        id: '5',
        ...
        jobDetails: {
          title: 'ITエンジニア',
          salary: '500-700万円',
          benefits: ['住宅手当', '交通費支給', '退職金制度'],
          requirements: ['理系学士', 'プログラミング経験'],
          description: '自動車製造におけるITシステムの開発・運用'
        }
      }
    ];
