  ...
  return (
    <main className="bg-white text-neutral-900 min-h-screen">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div className="absolute inset-0 opacity-[0.07] [background-image:url('data:image/svg+xml;utf8,<svg xmlns=\'https://www.w3.org/2000/svg\' width=\'160\' height=\'160\' viewBox=\'0 0 40 40\'><g fill=\'%23AAAAAA\' fill-opacity=\'0.4\'><circle cx=\'1\' cy=\'1\' r=\'1\'/></g></svg>')] [background-size:160px_160px]" />
      </div>
